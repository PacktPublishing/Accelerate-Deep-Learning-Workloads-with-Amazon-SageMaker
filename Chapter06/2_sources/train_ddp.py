...
def main():
    ...
    # Extend args with info about training cluster using world info collected by PyTorch
    args.world_size = dist.get_world_size()
    args.rank = dist.get_rank()
    args.local_rank = int(
        os.getenv("LOCAL_RANK")
    )  # Note that LOCAL_RANK is auto-set by torch.distributed.run in each training process
    LOGGER.info(
    ...
    dist.barrier()  # syncing on barrier to avoid bug: https://github.com/pytorch/pytorch/issues/69520
